 ...
 *    ...
 *    &lt;typedef name="<b>encryptedDoubleAsString</b>" class="org.jasypt.hibernate.type.EncryptedDoubleAsStringType">
 *      &lt;param name="encryptorRegisteredName"><b><i>myHibernateStringEncryptor</i></b>&lt;/param>
 *    &lt;/typedef>
 *    ...
 *    &lt;class name="UserData" table="USER_DATA">
 *      ...
 *      &lt;property name="salary" column="SALARY" type="<b>encryptedDoubleAsString</b>" />
 *      ...
 *    &lt;class>
 *    ...
 *  &lt;hibernate-mapping>
 ...
 * 
 */
public final class EncryptedDoubleAsStringType implements UserType, ParameterizedType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
        ...
        return rs.wasNull() ? 
                null : 
                new Double(this.encryptor.decrypt(message));
    }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index)
        ...
        if (value == null) {
            ...
            st.setString(
                    index, 
                    this.encryptor.encrypt(((Double) value).toString()));
        }
    }
