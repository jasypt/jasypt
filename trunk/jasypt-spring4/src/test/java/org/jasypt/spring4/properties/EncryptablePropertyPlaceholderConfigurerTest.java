...
public class EncryptablePropertyPlaceholderConfigurerTest extends TestCase {
    ...
    public void setUp() {
        this.encryptedSysPropKey = "thisIsAnEncryptedSysPropertyKey";
        this.encryptedValue = "encryptedString";
        this.encryptedValueWithDelimiters = ENCRYPTED_VALUE_PREFIX + this.encryptedValue + ENCRYPTED_VALUE_SUFFIX;
        this.expectedDecryptedValue = "clearText";
        System.setProperty(this.encryptedSysPropKey, this.encryptedValueWithDelimiters);

        this.unencryptedSysPropKey = "thisIsAnUNEncryptedSysPropertyKey";
        this.unencryptedValue = "thisIsARegularString";
        System.setProperty(this.unencryptedSysPropKey, this.unencryptedValue);
    }
    ...
    public void testConvertPropertyValueNotEncrypted() {
        ...
        assertEquals(this.unencryptedValue, eppc.convertPropertyValue(this.unencryptedValue));
    }

    public void testConvertPropertyValueDecryptWithStringEncryptor() {
        EncryptablePropertyPlaceholderConfigurer eppc = createPPCWithStringEncryptor();
        assertEquals(this.expectedDecryptedValue, eppc.convertPropertyValue(this.encryptedValueWithDelimiters));
    }
    ...
    public void testResolveSystemPropertyEncryptedSystemPropertyValue()
            throws Exception {
        EncryptablePropertyPlaceholderConfigurer ppc = createPPCWithTextEncryptor();
        assertEquals(this.expectedDecryptedValue, ppc.resolveSystemProperty(this.encryptedSysPropKey));
    }
    ...
    public void testResolveSystemPropertyUnencryptedSystemPropertyValue()
        ...
        assertEquals(this.unencryptedValue, ppc.resolveSystemProperty(this.unencryptedSysPropKey));
    }
    ...
    private EncryptablePropertyPlaceholderConfigurer createPPCWithTextEncryptor() {
        ...
        textEncryptor.addDecryption(this.encryptedValue, this.expectedDecryptedValue);
    ...
    private EncryptablePropertyPlaceholderConfigurer createPPCWithStringEncryptor() {
        ...
        stringEncryptor.addDecryption(this.encryptedValue, expectedDecryptedValue);
