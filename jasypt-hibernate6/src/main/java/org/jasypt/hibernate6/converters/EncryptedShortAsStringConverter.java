...
public class EncryptedShortAsStringConverter extends JasyptConverter<Short, String> {
    ...
    public static void setConverterConfig(final ConverterConfig converterConfig) {
        EncryptedShortAsStringConverter.converterConfig = converterConfig;
    }
    ...
    protected void checkInitialized() {
        if (!this.initialized) {
            if (converterConfig == null) {
                throw new ConverterInitializationException("Converter config is null for EncryptedShortAsStringConverter");
            } else {
