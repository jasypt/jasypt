...
public final class EncryptedPasswordDriverManagerConnectionProvider
    ...
    public void configure(final Properties props) {
        ...
        final String driver = props.getProperty(JAKARTA_JDBC_DRIVER);
        final String url = props.getProperty(JAKARTA_JDBC_URL);
        final String user = props.getProperty(JAKARTA_JDBC_USER);
        final String password = props.getProperty(JAKARTA_JDBC_PASSWORD);
        ...
        // covert properties to hashmap
        final Map<String, Object> decryptedProps = new HashMap<>();
        props.forEach((key, value) -> decryptedProps.put("" + key, value));


        // Let Hibernate process
        super.configure(decryptedProps);
