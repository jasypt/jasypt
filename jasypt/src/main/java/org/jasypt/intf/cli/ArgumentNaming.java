...
public class ArgumentNaming {
    ...
    public static final String ARG_ALGORITHM_SYS_PROPERY_NAME = 
        "algorithmSysPropertyName";
    public static final String ARG_INPUT = "input";
    public static final String ARG_INPUT_ENV_NAME = "inputEnvName";
    public static final String ARG_INPUT_SYS_PROPERTY_NAME = 
        "inputSysPropertyName";
    public static final String ARG_PASSWORD = "password";
    public static final String ARG_PASSWORD_ENV_NAME = "passwordEnvName";
    public static final String ARG_PASSWORD_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_ITERATIONS_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_KEY_OBTENTION_ITERATIONS_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_SALT_SIZE_BYTES_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_SALT_GENERATOR_CLASS_NAME_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_PROVIDER_CLASS_NAME_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_PROVIDER_NAME_ENV_NAME = 
        "providerNameEnvName";
    public static final String ARG_PROVIDER_NAME_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_UNICODE_NORMALIZATION_IGNORED_SYS_PROPERTY_NAME = 
    ...
    public static final String ARG_STRING_OUTPUT_TYPE_SYS_PROPERTY_NAME = 
