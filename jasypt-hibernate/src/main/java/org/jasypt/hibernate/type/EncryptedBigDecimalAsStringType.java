 ...
 *    ...
 *    &lt;typedef name="<b>encryptedBigDecimalAsString</b>" class="org.jasypt.hibernate.type.EncryptedBigDecimalAsStringType">
 *      &lt;param name="encryptorRegisteredName"><b><i>myHibernateStringEncryptor</i></b>&lt;/param>
 *    &lt;/typedef>
 *    ...
 *    &lt;class name="UserData" table="USER_DATA">
 *      ...
 *      &lt;property name="salary" column="SALARY" type="<b>encryptedBigDecimalAsString</b>" />
 *      ...
 *    &lt;class>
 *    ...
 *  &lt;hibernate-mapping>
 ...
 * 
 */
public final class EncryptedBigDecimalAsStringType implements UserType, ParameterizedType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
        ...
        return rs.wasNull() ? 
                null : 
                new BigDecimal(this.encryptor.decrypt(message));
    }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index)
        ...
        if (value == null) {
            ...
            st.setString(
                    index, 
                    this.encryptor.encrypt(((BigDecimal) value).toString()));
        }
    }
