 ...
 * 
 */
public final class EncryptedByteAsStringType implements UserType, ParameterizedType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
        ...
        return rs.wasNull() ? 
                null : 
                new Byte(this.encryptor.decrypt(message));
    }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index)
        ...
        if (value == null) {
            ...
            st.setString(
                    index, 
                    this.encryptor.encrypt(((Byte) value).toString()));
        }
    }
